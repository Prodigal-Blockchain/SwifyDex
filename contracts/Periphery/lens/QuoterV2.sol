...
import '../../Core/interfaces/callback/ISwifyDexSwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, ISwifyDexSwapCallback, PeripheryImmutableState {
    ...
    function getPool(address tokenA, address tokenB, uint24 fee) private view returns (ISwifyDexPool) {
    ...
    function SwifyDexSwapCallback(int256 amount0Delta, int256 amount1Delta, bytes memory path) external view override {
