...
/// @title NFT positions
/// @notice Wraps SwifyDex  positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the SwifyDex position
    struct Position {
    ...
    constructor(
        ...
        ERC721Permit("SwifyDex  Positions NFT-V1", "SwifyDex--POS", "1")
