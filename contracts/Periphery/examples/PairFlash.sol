...
import "../../Core/interfaces/callback/ISwifyDexFlashCallback.sol";
...
contract PairFlash is ISwifyDexFlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `SwifyDexFlashCallback`
